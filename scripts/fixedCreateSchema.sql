-- NIKOlearn MVP - Fixed Database Schema Creation
...
-- Create family links table (parent-student relationships) - FIXED with UUID primary key
...
-- Create chores table (family tasks with rewards) - FIXED to reference family_links.id
CREATE TABLE chores (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
